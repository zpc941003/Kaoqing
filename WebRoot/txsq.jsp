...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="row" style="margin-top: 15px">
                ...
                <div class="col-md-3">
                    <div class="form-group" style="margin-left: -15px">
                        <div style="">
                            <label for="dtp_input4" class="col-md-3 control-label">调休时间(起):</label>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="form-group" style="margin-left: -15px">
                        <div style="">
                            <label for="dtp_input6" class="col-md-3 control-label">调休时间(止):</label>
                        </div>
                        <div id="form_date3" class="input-group date form_date col-md-9" data-date="" data-date-format="yyyy MM dd" data-link-field="dtp_input6" data-link-format="yyyy-mm-dd">
                            <input class="form-control" id="dtp_input5" size="16" type="text" value="" readonly>
                            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $("#btn").bind("click", function() {//--------------------添加
            ...
            var date1 = new Date($("#dtp_input4").val())
            var date2 = new Date($("#dtp_input6").val())
        ...
        $("#alter").bind("click", function() {
            ...
            $('#form_date2').datetimepicker('update', json[0].starttime);
            $('#form_date3').datetimepicker('update', json[0].endtime);
